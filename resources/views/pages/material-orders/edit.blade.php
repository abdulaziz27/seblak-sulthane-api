                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            ...
                                            @else
                                                <input type="text" class="form-control"
                                                    value="{{ $materialOrder->franchise->name }}" disabled>
                                                <input type="hidden" name="franchise_id"
                                                    value="{{ $materialOrder->franchise_id }}">
                                            @endif
                                            @error('franchise_id')
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <div class="materials-container">
                                                @foreach ($materialOrder->items as $index => $orderItem)
                                                    <div class="row mb-3 material-row">
                                                        <div class="col-md-6">
                                                            <select class="form-control select2 material-select"
                                                                ...
                                                                @foreach ($rawMaterials as $rawMaterial)
                                                                    @php
                                                                        // Hitung stok tersedia tambahan untuk item yang sudah ada di pesanan ini
                                                                        $additionalAvailable =
                                                                            $rawMaterial->id ==
                                                                    ...
                                                                    <option value="{{ $rawMaterial->id }}"
                                                                        ...
                                                                        {{ $orderItem->raw_material_id == $rawMaterial->id ? 'selected' : '' }}>
                                                                        {{ $rawMaterial->name }} -
                                                            ...
                                                            <div class="material-details-container mt-2"
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="number" class="form-control quantity-input"
                                                                ...
                                                                placeholder="Jumlah" value="{{ $orderItem->quantity }}"
                                                                min="1" required>
                                                        </div>
                                                        <div class="col-md-2">
                                                            @if ($index > 0)
                                                                <button type="button"
                                                                    class="btn btn-danger remove-material">
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '.material-select', function() {
                ...
                if (selectedOption.val()) {
                    ...
                    // Update max attribute on quantity input to prevent over-ordering
            ...
            <div class="row mb-3 material-row">
                <div class="col-md-6">
                    ...
                    <div class="material-details-container mt-2" id="material-details-${index}">
                        <div class="stock-info"></div>
                        <div class="price-info"></div>
                    </div>
                </div>

                    ...
                    <div class="col-12 col-md-12 col-lg-4">
                        <div class="card profile-widget">
                            <div class="profile-widget-header">
                                ...
                                <div class="profile-widget-items">
                                    ...
                                    <div class="profile-widget-item">
                                        ...
                                        <div class="profile-widget-item-value">{{ $user->outlet ? $user->outlet->name : 'Not Assigned' }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="profile-widget-description pb-0">
                                ...
                                <p>Account created on {{ $user->created_at->format('M d, Y') }}</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <form method="POST" action="{{ route('profile.update') }}" class="needs-validation" novalidate="">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 col-12">
                                            <label>Current Password <small class="text-muted">(Only fill to change password)</small></label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 col-12">
                                            <label>Outlet</label>
                                            <input type="text" class="form-control" value="{{ $user->outlet ? $user->outlet->name : 'Not Assigned' }}" disabled>
                                        </div>
                                    </div>
                                </div>
